...
- **Tipografía personalizada** usando Lexend Deca para títulos y Tenor Sans para cuerpo mediante `next/font` y utilidades globales. (`lib/fonts.ts`, `styles/globals.css`)
